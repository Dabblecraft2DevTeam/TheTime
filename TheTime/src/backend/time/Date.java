...
public class Date {
	 ...
	 */
	public HashMap<DateEnum, Object> toHashMap(){
		
		HashMap<DateEnum, Object> dateMap = new HashMap<DateEnum, Object>();
		
		dateMap.put(DateEnum.tick, tick);
		dateMap.put(DateEnum.second, second);
		dateMap.put(DateEnum.minute, minute);
		dateMap.put(DateEnum.hour, hour);
		dateMap.put(DateEnum.day, day);
		dateMap.put(DateEnum.week, week);
		dateMap.put(DateEnum.month, month);
		dateMap.put(DateEnum.year, year);
		dateMap.put(DateEnum.era, era);
		
		dateMap.put(DateEnum.timeSystem, timeSystem);
